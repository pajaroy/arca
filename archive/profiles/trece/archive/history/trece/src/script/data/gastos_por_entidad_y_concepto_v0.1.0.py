...
# fecha: "2025-08-19"
# version: "0.1.0"
# descripcion: "Calcula gastos por entidad y concepto"
# ---
import pandas as pd
...
# 🔹 Agrupar gastos por entitie_id y concept_id
gastos = expenses.groupby(["entitie_id", "concept_id"])["amount"].sum().reset_index()

# 🔹 Unir con nombres de socios y conceptos
...
# 🔹 Mostrar en pantalla
print("📊 Gastos por socio y por concepto:")

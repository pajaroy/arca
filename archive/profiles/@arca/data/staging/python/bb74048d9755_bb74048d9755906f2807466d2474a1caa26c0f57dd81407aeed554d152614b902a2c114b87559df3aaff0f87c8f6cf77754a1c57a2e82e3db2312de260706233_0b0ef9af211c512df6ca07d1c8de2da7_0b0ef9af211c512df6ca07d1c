#!/usr/bin/env python3
"""
Script CLI mejorado para changelog de ALMA_RESIST con rutas configurables y validación semántica
"""
...
def main():
    ...
    try:
        ...
        if args.dry_run:
            print("\nMODO DRY-RUN: No se realizarán cambios permanentes")
            mostrar_resumen(nueva_entrada, args.changelog)
            print("Operación simulada exitosamente")
            return
        ...
        # Mostrar resumen
        mostrar_resumen(nueva_entrada, args.changelog)
        print(f"Changelog actualizado exitosamente en {args.changelog}")
